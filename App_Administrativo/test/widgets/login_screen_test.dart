...
void main() {
  ...
  group('AuthButton', () {
    ...
    testWidgets('deve exibir CircularProgressIndicator quando isLoading=true', (tester) async {
      await tester.pumpWidget(_wrap(
        AuthButton(
          text: 'Entrar',
          onPressed: () {},
    ...
    testWidgets('não deve chamar onPressed quando isLoading=true', (tester) async {
      bool chamado = false;
      await tester.pumpWidget(_wrap(
        AuthButton(
          text: 'Entrar',
  ...
  group('AuthFeedbackMessage', () {
    testWidgets('deve exibir mensagem de erro quando fornecida', (tester) async {
      await tester.pumpWidget(_wrap(
    ...
    testWidgets('deve exibir mensagem de sucesso quando fornecida', (tester) async {
      await tester.pumpWidget(_wrap(
        const AuthFeedbackMessage(
          errorMessage: null,
    ...
    testWidgets('não deve exibir nada quando ambas as mensagens são null', (tester) async {
      await tester.pumpWidget(_wrap(
        const AuthFeedbackMessage(
          errorMessage: null,
          successMessage: null,
    ...
    testWidgets('deve exibir ambas as mensagens quando as duas são fornecidas', (tester) async {
      await tester.pumpWidget(_wrap(
        const AuthFeedbackMessage(
  ...
  group('AuthInputField', () {
    testWidgets('deve exibir hint text corretamente', (tester) async {
      ...
      expect(find.widgetWithText(TextField, 'exemplo@email.com'), findsOneWidget);
    });
    ...
    testWidgets('deve obscureText quando configurado como senha', (tester) async {
      final controller = TextEditingController();
      await tester.pumpWidget(_wrap(
        AuthInputField(
          controller: controller,
  ...
  group('Validação de login — lógica de campos', () {
    testWidgets('deve mostrar erro "Preencha todos os campos" ao tentar login com campos vazios',
        (tester) async {
