...
class _PartidaFormScreenState extends State<PartidaFormScreen> {
  ...
  void initState() {
    ...
    _categoriaController = TextEditingController(text: widget.partida?.categoria ?? '');
    ...
    if (widget.partida?.agendadaPara != null) {
      ...
      _dataController = TextEditingController(
        text: '${dt.year}-${dt.month.toString().padLeft(2, '0')}-${dt.day.toString().padLeft(2, '0')}',
      );
  ...
  Future<void> _carregarModalidadesComPreselecao(
      String campeonatoId, String modalidadeIdAlvo) async {
  ...
  Future<void> _carregarEquipes(String modalidadeId) async {
    ...
    final equipesResult =
        await _apiService.listarEquipes(modalidadeId: modalidadeId);
  ...
  Future<void> _salvar() async {
    ...
    if (_selectedModalidadeId == null ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Selecione Modalidade e as duas Equipes.')),
      );
      return;
    }
    ...
    if (_dataController.text.isNotEmpty && _horaController.text.isNotEmpty) {
      ...
      final local = DateTime.parse('${_dataController.text}T${_horaController.text}:00');
      ...
      appBar: AppBar(
        title: Column(
          ...
          children: [
            ...
            if (isEditing)
              const Text('Campos preenchidos automaticamente',
                  style: TextStyle(
                      fontSize: 11,
                      ...
                      child: Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            // ── CABEÇALHO SEÇÃO ──
                            _buildSectionHeader(
                                Icons.emoji_events, 'Campeonato e Modalidade'),
                            const SizedBox(height: 12),

                            // ── CAMPEONATO ──
                            DropdownButtonFormField<String>(
                              decoration: _inputDecoration('Campeonato'),
                              value: _safeValue(_selectedCampeonatoId,
                            ...
                            _isLoadingEquipes
                                ...
                                : DropdownButtonFormField<String>(
                                    decoration: _inputDecoration(
                                        'Equipe A (Mandante)'),
                                    value: _safeValue(_selectedEquipeAId,
                            ...
                            _isLoadingEquipes
                                ...
                                : DropdownButtonFormField<String>(
                                    decoration: _inputDecoration(
                                        'Equipe B (Visitante)'),
                                    value: _safeValue(_selectedEquipeBId,
                                        _equipes.map((e) => e.id).toList()),
                                    items: _equipes.map((e) {
                                      return DropdownMenuItem<String>(
                                        value: e.id,
                            ...
                            const SizedBox(height: 22),
                            _buildSectionHeader(
                                Icons.info_outline, 'Informações extras'),
                            const SizedBox(height: 12),
                            ...
                            TextFormField(
                              ...
                              decoration:
                                  _inputDecoration('Local (Ginásio, Campo...)'),
                              validator: (v) =>
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration:
                                        _inputDecoration('Categoria (ex: Livre)'),
                                  ),
                                ),
                                const SizedBox(width: 14),
                                Expanded(
                                  child: TextFormField(
                                    ...
                                    decoration:
                                        _inputDecoration('Fase (ex: Final)'),
                                  ),
                                ),
                              ],
                            ),
